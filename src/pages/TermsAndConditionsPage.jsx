...
export default function TermsAndConditionsPage() {
  return (
    <Container className="terms-page-container my-5 p-4 bg-white rounded shadow-sm">
      ...
      <h1 className="text-center mb-4 terms-title">TÉRMINOS Y CONDICIONES PARA CREADORES EN <span className="text-fuchsia-electric">AECBlock</span></h1>
      ...
      <p>Al registrarse como Especialista en la Plataforma AECBlock, usted (“el Usuario”) acepta de forma expresa e íntegra estos Términos y Condiciones de Uso, los cuales regulan su participación como proveedor de productos digitales en el e-commerce de AECBlcok.</p>
      ...
      <p>b. El proceso de aceptación incluye la verificación de identidad, revisión de portafolio y/o experiencia previa, quedando AECBlock facultada para aceptar o rechazar el registro a su entera discreción.</p>
      ...
      <p>b. En caso de infracción a derechos de autor u otros derechos de terceros, AECBlock no será responsable por las consecuencias legales, contractuales o económicas derivadas de la publicación del producto.</p>
      <p>c. El Especialista se obliga a mantener indemne a AECBlock frente a cualquier reclamo de terceros que se derive de los productos cargados por su cuenta.</p>
      ...
      <p>b. No se permite la autopublicación. Todo producto debe ser aprobado previamente por AECBlock.</p>
      <p>c. AECBlock podrá sugerir ajustes y solicitar material complementario (fichas técnicas, imágenes, documentación de uso) previo a la publicación.</p>
      ...
      <p>b. Sin embargo, al subir su producto, otorga a AEClock una licencia no exclusiva, mundial y limitada, no transferible, para exhibir, promocionar y comercializar el producto en sus canales digitales.</p>

      <h2 className="terms-subtitle">6. Distribución de Ingresos</h2>
      <p>a. El Especialista recibirá el 50% de las ventas netas de sus productos. El 50% restante será retenido por AECBlock en concepto de curaduría, operación y marketing.</p>
      <p>b. Estos porcentajes podrán ser modificados en función de acuerdos específicos, especialmente si AECBlock participa activamente en la mejora, documentación o rediseño del producto.</p>
      ...
      <p>b. AECBlock podrá solicitar actualizaciones o despublicar productos obsoletos o que no cumplan con los estándares vigentes.</p>

      <h2 className="terms-subtitle">8. Causales de Suspensión o Terminación</h2>
      <p>AECBlock podrá suspender o cancelar la cuenta del Especialista en caso de:</p>
      <ul>
      ...
      <p>AECBlock se reserva el derecho de modificar estos Términos y Condiciones en cualquier momento, cuando lo considere necesario para reflejar cambios en sus operaciones, en la legislación aplicable, en las funcionalidades de la Plataforma o por cualquier otra razón justificada.</p>
